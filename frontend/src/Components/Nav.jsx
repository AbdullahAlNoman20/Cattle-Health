...
const Nav = () => {
  ...
  return (
    <div className=" p-2 bg-orange-500 text-black font-bold">
      <ToastContainer/>
      <section className="">
        <div className="navbar ">
          <div className="navbar-start">
            ...
            <a className="text-3xl font-extrabold">CattleSense</a>
          </div>
              ...
              <div className="flex items-center">
                <NavLink to="/login">
                  <button
                    ...
                    className="btn bg-red-700 text-white border-0 rounded-full"
                  >
