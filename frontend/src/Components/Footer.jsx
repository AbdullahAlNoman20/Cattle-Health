...
const Footer = () => {
  ...
  <nav>
    ...
    <a className="link link-hover">Smart Gateway</a>
    <a className="link link-hover">Smart Neck Tag</a>
    <a className="link link-hover">CattleSense App</a>
  </nav>
  <nav>
  ...
  <form>
    ...
    <fieldset className="form-control w-80">
      ...
      <div className="join">
        ...
        <button className="btn btn-warning bg-orange-500 border-gray-400 border-l-0 text-black join-item">Subscribe</button>
      </div>
    </fieldset>
  </form>
</footer>
